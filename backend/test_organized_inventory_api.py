...
async def main():
    ...
    print("⚠️ Note: Using mock token for testing. In production, get a real token from login.")
    ...
    for client_name, client_id in test_clients:
        ...
        if health_result and health_result.get("summary", {}).get("is_organized"):
            ...
            print(f"⚠️ Skipping analytics test - {client_name} data is not organized yet")
