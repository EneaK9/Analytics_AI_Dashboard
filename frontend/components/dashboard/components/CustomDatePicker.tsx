...
export default function CustomDatePicker({
	...
	const initialIsSelection =
		(initialValue as DateSelection | undefined) &&
		typeof (initialValue as any).date !== "undefined";
	const initialSingle = initialIsSelection
		? (initialValue as DateSelection).date
		: null;
	const initialStart =
		!initialIsSelection &&
		(initialValue as DateRange | undefined) &&
		(initialValue as DateRange).start
			? (initialValue as DateRange).start
			: null;
	const initialEnd =
		!initialIsSelection &&
		(initialValue as DateRange | undefined) &&
		(initialValue as DateRange).end
			? (initialValue as DateRange).end
			: null;
