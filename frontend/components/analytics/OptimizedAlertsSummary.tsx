...
const OptimizedAlertsSummary: React.FC<OptimizedAlertsSummaryProps> = memo(
	({
		...
		const [platform, setPlatform] = useState<"shopify" | "amazon" | "combined">(
			initialPlatform
		);
						...
						{error ? (
							...
							<div className="text-center py-8">
								...
								<p className="text-gray-600">
									...
									{platform === "combined" ? "any platform" : platform} in the
											...
											<div className="flex items-start gap-3">
												...
												<div className="flex-1">
													...
													<p className="text-sm text-gray-600 mb-2">
														{alertData.lowStockAlerts.length} SKUs need
														immediate attention
													</p>
													<div className="text-xs text-gray-500">
														...
														{alertData.lowStockAlerts.length > 3 && (
															<span className="ml-1">
																and {alertData.lowStockAlerts.length - 3}{" "}
																more...
															</span>
														)}
													</div>
										...
										<div className="flex items-start justify-between">
											<div className="flex items-start gap-3">
												...
												<div className="flex-1">
													...
													<p className="text-sm text-gray-600 mb-2">
														{alertData.overstockAlerts.length} SKUs have excess
														inventory
													</p>
													<div className="text-xs text-gray-500">
														<span className="font-medium">Affected SKUs: </span>
														...
														{alertData.overstockAlerts.length > 3 && (
															<span className="ml-1">
																and {alertData.overstockAlerts.length - 3}{" "}
																more...
															</span>
														)}
													</div>
