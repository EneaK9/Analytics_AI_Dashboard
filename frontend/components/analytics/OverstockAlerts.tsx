...
export default function OverstockAlerts({
	...
	const shopifyOverstockAlerts = useMemo(() => {
		return shopifyAlerts ? processOverstockAlerts(shopifyAlerts) : [];
	}, [shopifyAlerts]);

	const amazonOverstockAlerts = useMemo(() => {
		return amazonAlerts ? processOverstockAlerts(amazonAlerts) : [];
	}, [amazonAlerts]);

	const allOverstockAlerts = useMemo(() => {
		return [...shopifyOverstockAlerts, ...amazonOverstockAlerts];
	}, [shopifyOverstockAlerts, amazonOverstockAlerts]);
	...
	return (
		<div className={`space-y-4 ${className}`}>
			...
			<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
				{/* Shopify Overstock Alerts */}
				<AlertCard
					title="Shopify Overstock"
					alerts={shopifyOverstockAlerts}
				...
				{/* Amazon Overstock Alerts */}
				<AlertCard
					title="Amazon Overstock"
					alerts={amazonOverstockAlerts}
				...
				{/* All Platforms Overstock Alerts */}
				<AlertCard
					title="All Platforms"
					alerts={allOverstockAlerts}
