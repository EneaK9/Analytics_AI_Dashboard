...
const OptimizedInventoryTrendCharts: React.FC<OptimizedInventoryTrendChartsProps> =
	memo(
		({
			...
			return (
				<div className={`space-y-6 ${className}`}>
					...
					{showDatePicker && (
						<div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
							...
							<div className="flex items-center gap-2">
								...
								<select
									id="optimized-inventory-trend-platform"
									name="platform"
									value={platform}
									onChange={(e) =>
					...
					<div className="text-center text-sm text-gray-500">
						...
						• Date range: {dateRange.startDate} to {dateRange.endDate} • Showing{" "}
