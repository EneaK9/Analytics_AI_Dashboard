...
interface ShadcnRadialShapeProps {
	data: any[];
	title?: string;
	description?: string;
	minimal?: boolean;
...
const ShadcnRadialShape: React.FC<ShadcnRadialShapeProps> = ({
	data,
	...
	const chartData = React.useMemo(() => {
		...
		// Use first data item for radial shape display
...
export default ShadcnRadialShape;
